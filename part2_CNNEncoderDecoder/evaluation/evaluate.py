...
EVAL_DIR    = Path('/cluster/tufts/c26sp1cs0137/nliu05/assignment3/part2/evaluation')          # evaluation/
ROOT        = Path('/cluster/tufts/c26sp1cs0137/data/assignment3_data')               # assignment3_data/
