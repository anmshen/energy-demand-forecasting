...
from data.assignment3_data.evaluation.as_nl.model import CNNTransformerModel
...
def run_epoch(model, loader, optimizer, device, train=True):
    ...
    with ctx:
        for batch in loader:
            if batch is None:
                continue
            # Dataset returns 6 tensors: (hist_weather_full, hist_energy, fut_weather_full, hist_time_feats, fut_time_feats, target)
...
def main():
    ...
    # --- Model: CNN-Transformer Patch Architecture ---
